...
export const StreamPlayer: FC<StreamPlayerProps> = ({user, stream, isFollowing}) => {
  ...
  return <> 
    ...
    >
      <div className='space-y-4 col-span-1 lg:col-span-2 xl:col-span-2 2xl:col-span-5 lg:overflow-y-auto hidden-scrollbar pb-6'>
        <Video
...
export const StreamPlayerSkeleton: FC = () => {
